...
1. Run `process-run.py` with the following flags: `-l 5:100,5:100`. What should the CPU utilization be (e.g., the percent of time the CPU is in use?) Why do you know this? Use the `-c` and `-p` flags to see if you were right.
   ...
   ![image](https://github.com/user-attachments/assets/2efb55f1-a89a-4475-a981-929f152c6b23)
   Conociendo que el proceso 0 ejecuta 5 unidades de cpu y luego realiza 100 unidades de I/O durante el cual este no utiliza la CPU, mientras que el proceso 0 esta esperando I/O, el proceso 1 ejecuta 5 unidades de cpu y luego realiza 100 unidades de I/O  
      # Calculo de la utilización de la CPU 
>  
>
   </details>
   <br>
